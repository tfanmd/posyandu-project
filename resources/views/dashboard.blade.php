            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6 border-l-4 border-emerald-500">
                <div class="p-6 text-gray-900">
                    ...
                    <p class="text-sm text-gray-600 mt-1">
                        ...
                        <span class="px-2 py-1 bg-gray-100 rounded text-emerald-700 font-bold uppercase text-xs tracking-wider">
                            {{ Auth::user()->role }}
                        </span>
                    </p>
                </div>
                ...
                @if(Auth::user()->role === 'admin')
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg hover:shadow-md transition duration-200">
                        <div class="p-6">
                            ...
                            <p class="text-sm text-gray-600 mb-4">Kelola pendaftaran akun dan hak akses operasional kader.</p>
                            <a href="#" class="text-emerald-600 text-sm font-semibold hover:text-emerald-800">Kelola Data &rarr;</a>
                        </div>
                    </div>
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg hover:shadow-md transition duration-200">
                        <div class="p-6">
                            ...
                            <p class="text-sm text-gray-600 mb-4">Persetujuan (approval) berita posyandu dan artikel edukasi gizi.</p>
                            <a href="#" class="text-blue-600 text-sm font-semibold hover:text-blue-800">Kelola Konten &rarr;</a>
                        </div>
                    </div>
                ...
                @elseif(Auth::user()->role === 'kader')
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg hover:shadow-md transition duration-200">
                        <div class="p-6">
                            ...
                            <p class="text-sm text-gray-600 mb-4">Inisiasi agenda penimbangan, imunisasi, dan kelas ibu hamil.</p>
                            <a href="#" class="text-green-600 text-sm font-semibold hover:text-green-800">Input Jadwal &rarr;</a>
                        </div>
                    </div>
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg hover:shadow-md transition duration-200">
                        <div class="p-6">
                            ...
                            <p class="text-sm text-gray-600 mb-4">Pencatatan riwayat pemeriksaan Balita dan Ibu Hamil.</p>
                            <a href="#" class="text-pink-600 text-sm font-semibold hover:text-pink-800">Kelola Data &rarr;</a>
                        </div>
                    </div>
                @endif
